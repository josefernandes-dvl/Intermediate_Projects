...
namespace GradingSystem
{
    internal class Program
    {
        ...
        inicio:
            ...
            int totalStudents = Convert.ToInt32(Console.ReadLine()); // Defines the size of arrays.
            double[] math = new double[totalStudents]; 
            double[] science = new double[totalStudents]; 
            double[] english = new double[totalStudents]; 
            double[] essay = new double[totalStudents]; // ^^ Arrays to store the grades of each subject. ^^
            double[] averages = new double[totalStudents]; // Array to store the final averages of each student.
            double[] averages2 = new double[totalStudents]; // Copy of the array "averages" to sort the grades.
            ...
            for (int i = 0; i < totalStudents; i++)
            {
                ...
                switch (index) // Switch to choose course and apply weighted average.
                { 
                    case 1:
            ...
            inicio2: //Beginning of the second part of the program.
            Console.Clear();
            ...
            switch (response) // Switch to manipulate the grades.
            {
                case 1:
                    for(int i = 0; i<totalStudents; i++)
                    {
                ...
                case 3:
                    Console.Clear();
                    Array.Copy(averages, averages2, totalStudents); // Copy necessary to maintain the original number of the students.
                    Array.Sort(averages2);
        ...
        //The distribuition of the weights of the subjects in the courses.
